        ...
        <div className="bg-[#ffffff] shadow-sm sticky top-0 z-10">
          <div className="p-4">
            <div className="flex items-center space-x-3">
              ...
              <h1 className="text-xl font-semibold text-[#1f2937]">Order Not Found</h1>
            </div>
          </div>
        </div>
        <div className="p-4 text-center">
          <p className="text-[#6b7280]">The order you're looking for doesn't exist.</p>
        </div>
      </div>
    );
  }
        ...
        <div className="p-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-xl font-semibold text-[#1f2937]">Track Order</h1>
          ...
          <div className="p-6">
            <div className="flex items-center justify-between mb-4">
              <div>
                ...
                <p className="text-sm text-[#6b7280]">{deliveryEstimate}</p>
              </div>
              <span
            ...
            <div>
              ...
              <div className="space-y-3">
                ...
                {order.specialInstructions && (
                  <div className="flex items-start space-x-3">
                    <MessageCircle className="w-5 h-5 text-[#6b7280] mt-0.5" />
                    <div>
