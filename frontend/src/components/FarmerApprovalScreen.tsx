          ...
          <div className="p-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h1 className="text-lg font-semibold text-foreground">Farmer Application Review</h1>
          ...
          <div className="bg-white rounded-lg shadow">
            <div className="p-6 flex items-start space-x-4 mb-4">
              ...
              <div className="flex-1">
                <h2 className="text-xl font-semibold text-foreground mb-1">{selectedFarmer.name}</h2>
                <p className="text-sm text-muted-foreground mb-2">{selectedFarmer.farmName}</p>
            ...
            <div className="p-6 space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <p className="text-foreground">{selectedFarmer.farmSize}</p>
                </div>
                <div>
                  <label className="text-sm font-medium text-muted-foreground">Experience</label>
                  <p className="text-foreground">{selectedFarmer.experience}</p>
                </div>
              </div>
              <div>
                <label className="text-sm font-medium text-muted-foreground">Certification</label>
                <p className="text-foreground">{selectedFarmer.certification}</p>
              </div>
              <div>
                <label className="text-sm font-medium text-muted-foreground">Primary Crops</label>
          ...
          {selectedFarmer.status === 'pending' && (
            <div className="flex space-x-4 pb-8">
              <button
                ...
                className="flex-1 bg-green-600 hover:bg-green-700 text-white rounded px-4 py-2 font-medium flex items-center justify-center"
              >
              ...
              <button
                ...
                className="flex-1 bg-red-600 hover:bg-red-700 text-white rounded px-4 py-2 font-medium flex items-center justify-center"
              >
        ...
        <div className="p-4">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-lg font-semibold text-foreground">Farmer Applications</h1>
                <p className="text-sm text-muted-foreground">
        ...
        <div className="space-y-4">
          <div className="grid w-full grid-cols-4 mb-4">
            <button
              ...
              className={`py-2 px-4 font-medium border-b-2 ${activeTab === 'all' ? 'border-primary text-primary' : 'border-transparent text-muted-foreground'} focus:outline-none`}
            >
              All ({farmers.length})
            </button>
            <button
              ...
              className={`py-2 px-4 font-medium border-b-2 ${activeTab === 'pending' ? 'border-primary text-primary' : 'border-transparent text-muted-foreground'} focus:outline-none`}
            >
            ...
            <button
              ...
              className={`py-2 px-4 font-medium border-b-2 ${activeTab === 'approved' ? 'border-primary text-primary' : 'border-transparent text-muted-foreground'} focus:outline-none`}
            >
            ...
            <button
              ...
              className={`py-2 px-4 font-medium border-b-2 ${activeTab === 'rejected' ? 'border-primary text-primary' : 'border-transparent text-muted-foreground'} focus:outline-none`}
            >
          ...
          <div className="space-y-4 mt-6">
            {filteredFarmers.length === 0 ? (
              <div className="text-center py-12">
                ...
                <h3 className="font-medium text-foreground mb-2">No farmers found</h3>
                <p className="text-sm text-muted-foreground">
                          ...
                          <div className="flex-1 min-w-0">
                            <div className="flex items-start justify-between mb-2">
                              <div className="flex-1 min-w-0 pr-4">
                                ...
                                <p className="text-sm text-muted-foreground truncate">{farmer.farmName}</p>
                          ...
                          {farmer.status === 'pending' && (
                            <>
                              <button
                                ...
                                disabled={completionRate < 100}
                                className="bg-green-600 hover:bg-green-700 text-white px-3 py-1 rounded text-sm flex-shrink-0 flex items-center"
                              >
